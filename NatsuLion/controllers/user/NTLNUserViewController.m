...
#import "NTLNUserFollowersListViewController.h"
#import "NTLNUserFollowingListViewController.h"
...
- (void)tableView:(UITableView *)tView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (userInfo) {
		switch (row){
			...
			case 4:
			{
				NTLNUserFollowingListViewController *vc = [[[NTLNUserFollowingListViewController alloc] init] autorelease];
				vc.screenName = userInfo.screen_name;
				[[self navigationController] pushViewController:vc animated:YES];
			}
				break;
			case 5:
			{
				NTLNUserFollowersListViewController *vc = [[[NTLNUserFollowersListViewController alloc] init] autorelease];
				vc.screenName = userInfo.screen_name;
				[[self navigationController] pushViewController:vc animated:YES];
			}
				break;
